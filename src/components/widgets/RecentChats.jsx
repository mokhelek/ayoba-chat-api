...
import avatar from "../../assets/m2H7H7N4b1Z5H7m2.png"
                    ...
                    <div className="recent-chat-wrapper">
                        <div className="d-flex">
                            ...
                            <div style={{ marginLeft: "1rem", marginTop: "5px" }} >
                                ...
                                <small style={{ margin: 0, fontSize: "0.75rem" }} className='text-secondary'> Necessitatibus sapiente voluptatibus impedit.</small>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div className="row mb-3">
                    <div className="recent-chat-wrapper">
                        <div className="d-flex">
                            ...
                            <div style={{ marginLeft: "1rem", marginTop: "5px" }} >
                                <h6 style={{ color: '#645fec', fontWeight: '600', marginBottom: 0, fontSize: "0.9rem" }}> +27 984 4742 </h6>
                                <small style={{ margin: 0, fontSize: "0.75rem" }} className='text-secondary'> Lorem ipsum. Necessitatibus sapiente impedit.</small>
                            </div>
                        </div>
                    </div>
                </div>
